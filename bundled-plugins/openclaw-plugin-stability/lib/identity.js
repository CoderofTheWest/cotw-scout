...
const INJECTED_BLOCK_HEADERS = [
    ...
    '[YOUR WORKING MEMORY]', '[YOUR COHERENCE]', '[PATTERNS YOU\'RE DEVELOPING]',
    '[WHERE THEY STAND', '[WHAT YOU\'VE BEEN THINKING ABOUT]',
    '[WHAT YOU REMEMBER FROM LAST SESSION]', '[WHAT YOU THOUGHT ABOUT OVERNIGHT]',
    '[YOUR THREAD NOTES', '[INFRASTRUCTURE NOTE]',
    // Legacy headers
    '[CONTINUITY CONTEXT]', '[STABILITY CONTEXT]', '[GROWTH VECTORS]',
    '[CONTEMPLATION STATE]', '[STANDING CONTEXT]', '[SESSION HANDOFF',
    '[NIGHTSHIFT REPORT', '[THREAD CONTEXT',
    // Unchanged
    '[ACTIVE PROJECTS]', '[ACTIVE CONSTRAINTS]', '[GRAPH CONTEXT]',
    '[GRAPH NOTE]', '[TOPIC NOTE]',
...
class Identity {
     ...
     */
    async DANGEROUS_processTurn(userMessage, responseText, entropyScore, memoryApi, vectorStore, _reason = 'turn processing') {
    ...
    _createCandidateVector(userMessage, responseText, entropyScore, tensions, vectorStore) {
        ...
        vectorStore.DANGEROUS_addCandidate(candidate, 'principle-aligned resolution detected');
