...
function identifyGaps({ messages, entropy = 0, extractionConfig = {}, source }) {
    ...
    // Collect text from both user and agent messages
    ...
    // NOTE: entropy/surprise gating is handled at the call site (index.js)
    // using cognitive dynamics surprise + stability entropy. This function
    // just extracts — it doesn't decide whether to contemplate.
