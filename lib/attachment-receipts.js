...
function createAttachmentReceipts({ db, attachments = [], threadId = null, sessionId = null, projectId = null, turnId = null, now = new Date().toISOString() } = {}) {
  ...
  const insertTurn = db.prepare(`
    INSERT OR IGNORE INTO attachment_receipt_turns
      (id, receipt_id, thread_id, session_id, project_id, turn_id, created_at)
    VALUES
      (@id, @receiptId, @threadId, @sessionId, @projectId, @turnId, @createdAt)
  `);
